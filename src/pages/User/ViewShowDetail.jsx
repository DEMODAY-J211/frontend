        ...
        <ShowContainer>
          <ShowInfo>
            ...
            <div className="wrapper">
              <a>공연 날짜·회차</a>
              <b>
                1회차 9월 25일 / 15:00~16:00 <br />
                2회차 9월 25일 / 18:00~19:00
              </b>
            </div>
            <div className="wrapper">
              <a>예매 기한</a>
              <b>2025.09.01 ~ 각 공연 시작 1시간 전</b>
            </div>
            <div className="wrapper">
              <a>티켓</a>
              <b>
          ...
          <ShowTab hasGroupInfo={true}></ShowTab>
        </ShowContainer>
        <Footerbtn
...
const Footer = styled.div`
  ...
  // width: 393px;
  padding: 10px;
  flex-direction: ${(props) => (props.twoprops ? "" : "column")};;
  align-items: flex-start;
  gap: 10px;
  ...
  .btn-red {
    ...
    color: ${(props) => (props.reservable ? "#fff1f0" : "#fff")};#;
    &:hover {
