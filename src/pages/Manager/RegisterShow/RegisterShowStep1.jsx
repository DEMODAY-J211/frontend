...
const RegisterShowStep1 = () => {
  ...
  const hasEmptyStart = showSchedules.some(sch => sch.startTime.trim() === "");
    ...
    <Container>
        <MainContent>
          ...
          <FormContent>
            <LeftContent>
                <Name>대표 포스터</Name>
                    <Poster onClick={() => document.getElementById("posterUpload").click()}>
                        {preview ? (
                            <>
            ...
            <RightContent>
                ...
                <DateRow key={idx}>
                    ...
                    onChange={(e) => {
                        ...
                        if (e.target.value.trim() !== "") setShowDateError(false);
                    }}
                    ...
                    onChange={(e) => {
                        ...
                        if (e.target.value.trim() !== "") setShowTimeError(false);
                    }}
                    className={sch.startTime === "" ? "placeholder" : ""}
                    >
                    <option value="" disabled className="placeholder">00:00</option>
                ...
                onChange={(e) => {
                    ...
                    if (e.target.value.trim() !== "") setReserveDateError(false);
                }}
                ...
                onChange={(e) => {
                    ...
                    if (e.target.value.trim() !== "") setReserveTimeError(false);
                }}
                ...
                {ticketOptions.map((opt, idx) => (
                    ...
                    <Input
                        ...
                        value={opt.detail}
                        onChange={(e) => updateTicketOption(idx, "detail", e.target.value)}
                ...
                <AccountRow>
                    ...
                    <option value="" disabled className="placeholder">은행명</option>
                    <option>우리</option>
                    <option>신한</option>
                    <option>국민</option>
                    <option>하나</option>
