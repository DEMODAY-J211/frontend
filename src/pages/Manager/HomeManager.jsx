      ...
      {registerShowModal === "first" && (
        <ModalOverlay onClick={handleCloseRegisterModal}>
          <ModalContent onClick={(e) => e.stopPropagation()}>
            ...
            <ModalButtonGroup>
              <ModalButton primary onClick={() => navigate("/registervenue")}>
                공연장 등록하기
              </ModalButton>
            </ModalButtonGroup>
          </ModalContent>
      ...
      {registerShowModal === "continue" && (
        <ModalOverlay onClick={handleCloseRegisterModal}>
          <ModalContent onClick={(e) => e.stopPropagation()}>
            ...
            <ModalButtonGroup>
              <ModalButton primary onClick={() => navigate("/registershow")}>
                네, 등록할래요
              </ModalButton>
      ...
      {registerShowModal === "duplicate" && (
        <ModalOverlay onClick={handleCloseRegisterModal}>
          <ModalContent onClick={(e) => e.stopPropagation()}>
            ...
            <ModalButtonGroup>
              <ModalButton onClick={() => navigate("/registervenue")}>
                공연장 등록하기
              </ModalButton>
              <ModalButton primary onClick={() => navigate("/registershow")}>
                이미 등록했어요
        ...
        <ModalOverlay onClick={handleCloseRegisterModal}>
          <ModalContent onClick={(e) => e.stopPropagation()}>
            ...
            <ModalButtonGroup>
              <ModalButton
                primary
                onClick={() => navigate("/registershow?mode=continue")}
              >
                이어서 등록하기
              </ModalButton>
              <ModalButton onClick={() => navigate("/registershow")}>
                새로운 공연 등록하기
              </ModalButton>
            </ModalButtonGroup>
          </ModalContent>
