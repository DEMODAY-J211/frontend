  ...
  return (
    ...
    {registerShowModal === 'tempDone' && (
        <ModalOverlay onClick={handleCloseRegisterModal}>
            <ModalContent onClick={(e) => e.stopPropagation()}>
                <CloseButton onClick={handleCloseRegisterModal}>×</CloseButton>
                <ModalTitle>임시저장 없이<br/>공연 등록을 중단하시겠어요?</ModalTitle>
                <ModalSubtitle>* 주의! 중단 시<br/>입력된 정보들은 사라지니 유의해주세요!</ModalSubtitle>
                <ModalButtonGroup>
                    <ModalButton primary onClick={() => {/* 임시저장 로직 */}}>임시 저장하기</ModalButton>
                    <ModalButton onClick={handleCloseRegisterModal}>중단하기</ModalButton>
                </ModalButtonGroup>
            </ModalContent>
        </ModalOverlay>
    )}
